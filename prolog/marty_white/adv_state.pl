...
delprop(Object, Prop, S0, S2) :- notrace(must_det((correct_props(Object,Prop,PropList), each_prop(delprop_(Object), PropList, S0, S2)))).
...
delprop_always(Object, Prop, S0, S2) :- notrace(must_det((correct_props(Object,Prop,PropList), each_prop(delprop_always_(Object), PropList, S0, S2)))).
