...
init_objects(S0, S2) :-
 must_det((must_input_state(S0), 
 create_missing_instances(S0,S1), !,
 must_det(call((get_objects(true,ObjectList, S1), ObjectList\==[]))),
...
%visit_existing(Object, Prop, S1, S2):- must_det(create_objprop(Object, Prop, S1, S2)).

visit_existing(Object, Prop, S1, S2):- Prop=inherit(_,t),!,must_det(create_objprop(Object, Prop, S1, S2)).
visit_existing(Object, Prop, S0, S2):- must_det(updateprop(Object,Prop,S0, S2)).
*/ 
...
create_objprop(Object, inherit(Other,t), S0, S9):- 
 ...
 %must_det(updateprop(Object, visited(Other), S0, S1)),
 must_det(updateprop(Object, inherited(Other), S0, S2)),
 
 must_det(create_objprop(Object, PropListC, S2, S9)),
 %must_det(setprop(Object, inherited(Other), S3, S9)),
 !.
...
create_instances(Suffix,Info,[Prop|TODO],S0,S3):-
 ...
 must_det((select(Prop,S0,S1))),
 must_det((create_objs(Objs,NewObjs,Suffix,Info,S1,S2),
