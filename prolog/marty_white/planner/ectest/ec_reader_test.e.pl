...
predicate(terminates(event,fluent,time)).
predicate(releases(event,fluent,time)).
holds_at(fluent,time),neg(releasedAt(fluent,time+1)),neg((happens(event,time),terminates(event,fluent,time)))->holds_at(fluent,time+1).
neg(holds_at(fluent,time)),neg(releasedAt(fluent,time+1)),neg((happens(event,time),initiates(event,fluent,time)))->neg(holds_at(fluent,time+1)).
neg(releasedAt(fluent,time)),neg((happens(event,time),releases(event,fluent,time)))->neg(releasedAt(fluent,time+1)).
releasedAt(fluent,time),neg((happens(event,time),(initiates(event,fluent,time);terminates(event,fluent,time))))->releasedAt(fluent,time+1).
...
<->(started(fluent,time),(holds_at(fluent,time);happens(event,time),initiates(event,fluent,time))).
<->(stopped(fluent,time),(neg(holds_at(fluent,time));happens(event,time),terminates(event,fluent,time))).
predicate(initiated(fluent,time)).
predicate(terminated(fluent,time)).
<->(initiated(fluent,time),(started(fluent,time),neg((happens(event,time),terminates(event,fluent,time))))).
<->(terminated(fluent,time),(stopped(fluent,time),neg((happens(event,time),initiates(event,fluent,time))))).
...
holds_at(at(Object,Location1),Time),holds_at(at(Object,Location2),Time)->'$var'(location1,Location2).
% connectivity
...
holds_at(diameter(Ball,Diameter1),Time),holds_at(diameter(Ball,Diameter2),Time)->'$var'(diameter1,Diameter2).
% Effect axiom state that if an agent rolls some snow along
% some other snow, the diameter of the first snow will increase:
holds_at(diameter(Snow1,Diameter1),Time),'$var'(diameter2,Diameter1+1)->initiates(rollAlong(Agent,Snow1,Snow2),diameter(Snow1,Diameter2),Time).
...
neg(partOf(physobj,object)),holds_at(at(agent,location),time)->initiates(letGoOf(agent,physobj),at(physobj,location),time).
...
partOf(physobj1,physobj2),neg(partOf(physobj2,object)),holds_at(at(agent,location),time)->initiates(letGoOf(agent,physobj1),at(physobj2,location),time).
...
holds_at(height(Object,Height1),Time),holds_at(height(Object,Height2),Time)->'$var'(height1,Height2).
...
happens(startFallingFromTo(Physobj1,Physobj2,Physobj3),Time),holds_at(height(Physobj1,Height1),Time),holds_at(height(Physobj2,Height2),Time)->'$var'(height1,Height2).
...
holds_at(height(Physobj1,Height1),Time),'$var'(height2,Height1-Offset)->trajectory(fallingFromTo(Physobj1,Physobj2,Physobj3),Time,height(Physobj1,Height2),Offset).
...
happens(startFlyingFromTo(Agent,Physobj1,Physobj2),Time),holds_at(height(Agent,Height1),Time),holds_at(height(Physobj1,Height2),Time)->'$var'(height1,Height2).
...
% at a time equal to the time plus the offset:
holds_at(height(Agent,Height1),Time),'$var'(height2,Height1+Offset)->trajectory(flyingFromTo(Agent,Physobj1,Physobj2),Time,height(Agent,Height2),Offset).
% A trigger axiom states that
...
neg(partOf(physobj,object)),holds_at(height(physobj,height),time)->initiates(letGoOf(agent,physobj),height(physobj,height),time).
% A state constraint says that
...
holds_at(gridAt(Grid,Object,Coord1,Coord2),Time),holds_at(gridAt(Grid,Object,Coord3,Coord4),Time)->'$var'(coord1,Coord3),'$var'(coord2,Coord4).
% An effect axiom states that
...
% the second cell:
happens(gridWalk(grid,agent,coord1,coord2,coord3,coord4),time)->holds_at(gridAt(grid,agent,coord1,coord2),time),neg(holds_at(gridAt(grid,object,coord3,coord4),time)),(coord1=coord3;coord1=coord3+1;coord1=coord3-1),(coord2=coord4;coord2=coord4+1;coord2=coord4-1).
...
sort(color).
% constants
% gleaned(isa(round,shape)).
% gleaned(isa(square,shape)).
shape([round,square]).
% gleaned(isa(red,color)).
% gleaned(isa(green,color)).
color([red,green]).
...
shape(Object,Shape1),shape(Object,Shape2)->'$var'(shape1,Shape2).
% objects have unique color
color(Object,Color1),color(Object,Color2)->'$var'(color1,Color2).
% if objects are the same, they have the same shape
equal(object1,object2)->shape(object1,shape),shape(object2,shape).
% if objects are the same, they have the same color
equal(object1,object2)->color(object1,color),color(object2,color).
% if objects are the same, they have the same location
equal(Object1,Object2)->holds_at(location(Grid,Object1,Xcoord1,Ycoord1),Time),holds_at(location(Grid,Object2,Xcoord2,Ycoord2),Time)->'$var'(xcoord1,Xcoord2),'$var'(ycoord1,Ycoord2).
% object in one location at a time
holds_at(location(Grid,Object,Xcoord1,Ycoord1),Time),holds_at(location(Grid,Object,Xcoord2,Ycoord2),Time)->'$var'(xcoord1,Xcoord2),'$var'(ycoord1,Ycoord2).
...
happens(move(Grid,Object,Xcoord1,Ycoord1,Xcoord2,Ycoord2),Time)->holds_at(location(Grid,Object,Xcoord1,Ycoord1),Time),('$var'(xcoord1,Xcoord2),('$var'(ycoord1,Ycoord2+1);'$var'(ycoord1,Ycoord2-1));'$var'(ycoord1,Ycoord2),('$var'(xcoord1,Xcoord2+1);'$var'(xcoord1,Xcoord2-1))).
...
holds_at(lyingOn(Agent,Physobj1),Time),holds_at(lyingOn(Agent,Physobj2),Time)->'$var'(physobj1,Physobj2).
holds_at(sittingOn(Agent,Physobj1),Time),holds_at(sittingOn(Agent,Physobj2),Time)->'$var'(physobj1,Physobj2).
...
% gleaned(isa(menu1,ona)).
% gleaned(isa(food1,ona)).
% gleaned(isa(bill1,ona)).
ona([menu1,food1,bill1]).
onb(table1).
% gleaned(isa(customer1,ordera)).
% gleaned(isa(waiter1,ordera)).
ordera([customer1,waiter1]).
% gleaned(isa(waiter1,orderb)).
% gleaned(isa(cook1,orderb)).
orderb([waiter1,cook1]).
orderc(food1).
requesta(customer1).
requestb(waiter1).
requestc(bill1).
% gleaned(isa(customer1,holda)).
% gleaned(isa(waiter1,holda)).
holda([customer1,waiter1]).
% gleaned(isa(menu1,holdb)).
% gleaned(isa(food1,holdb)).
% gleaned(isa(bill1,holdb)).
holdb([menu1,food1,bill1]).
holdc(table1).
sita(customer1).
sitb(chair1).
% gleaned(isa(customer1,greeta)).
% gleaned(isa(waiter1,greeta)).
greeta([customer1,waiter1]).
% gleaned(isa(customer1,greetb)).
% gleaned(isa(waiter1,greetb)).
...
holds_at(beWaiter3(waiterOf(restaurant)),time),holds_at(knowOrder(waiterOf(restaurant),agent,food),time)->happens(order(waiterOf(restaurant),cookOf(restaurant),food),time).
...
holds_at(beWaiter4(waiter),time),holds_at(knowOrder(waiter,agent,food),time),holds_at(foodPrepared(food),time)->happens(pickUp(waiter,food),time).
holds_at(beWaiter4(waiter),time),holds_at(knowOrder(waiter,agent,food),time)->terminates(pickUp(waiter,food),beWaiter4(waiter),time).
holds_at(beWaiter4(waiter),time),holds_at(knowOrder(waiter,agent,food),time)->initiates(pickUp(waiter,food),beWaiter5(waiter),time).
...
holds_at(atDepth(Object,Depth1),Time),holds_at(atDepth(Object,Depth2),Time)->'$var'(depth1,Depth2).
...
happens(putOn(diver,equipment),time)->neg(holds_at(wearing(diver1,equipment),time)).
...
happens(ascend1(diver),time),neg(happens(rapidAscendToSurface(diver),time)),neg(holds_at(holding(diver,diver1),time))->happens(rotateYaw(diver),time).
...
happens(enterWater(diver),time)->neg(holds_at(holding(diver1,diver),time)).
'$var'(depth,0)->initiates(enterWater(Object),atDepth(Object,Depth),Time).
...
% gleaned(isa(positivelyBuoyant,mutex)).
% gleaned(isa(neutrallyBuoyant,mutex)).
% gleaned(isa(negativelyBuoyant,mutex)).
...
holds_at(ascendDescendAmount(Diver,Depth1),Time),holds_at(ascendDescendAmount(Diver,Depth2),Time)->'$var'(depth1,Depth2).
happens(descend(diver,depth),time)->holds_at(negativelyBuoyant(diver),time),holds_at(ascendDescendAmount(diver,depth1),time),holds_at(atDepth(diver,depth-depth1),time).
event(kickUp(diver)).
happens(ascend(diver,depth),time)->(holds_at(positivelyBuoyant(diver),time);holds_at(neutrallyBuoyant(diver),time),happens(kickUp(diver),time)),holds_at(ascendDescendAmount(diver,depth1),time),holds_at(atDepth(diver,depth+depth1),time).
...
<->(happens(descend1(diver),time),happens(descend(diver,depth),time)).
<->(happens(ascend1(diver),time),happens(ascend(diver,depth),time)).
...
event(panic(diver)).
happens(panic(diver),time)->holds_at(disoriented(diver),time);holds_at(uncontrolledBuoyancy(diver),time);happens(lose(diver,equipment),time-1);happens(vomit(diver),time-1).
event(vomit(diver)).
% conditions
...
holds_at(signalingDecompress(computer,diver),time)->neg(time1<time),happens(decompress(diver),time1).
...
happens(decompress(diver),time)->(depth>0,holds_at(atDepth(diver,depth),time)),neg(holds_at(uncontrolledBuoyancy(diver),time)).
